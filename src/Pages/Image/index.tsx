...
const Image: React.FC<Props> = () => {
  ...
  return (
    <S.Aside>
      <Example
        ...
        description={
          <>
            ...
            image asset in parentheses. You can optionally add a title after the URL in the parentheses. Let's grab some
            urls from {''}
      ...
      <Example description="To add a link to an image, enclose the Markdown for the image in brackets, and then add the link in parentheses." />
